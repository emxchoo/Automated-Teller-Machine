...
class AutomatedTellerMachine:
    ...
    def __init__(self,name,balance):
        #setting both name and balance as private data variables
   ...
   #To set name
    ...
    #To access private variable self.__username
    def get_name(self):
...
def main():
    ...
    #Using while loop to run this program 
    while True:
